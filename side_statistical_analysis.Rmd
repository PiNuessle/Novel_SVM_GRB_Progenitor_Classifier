...
#        pch = c(20, 20, 20, 20))
###
Goldstein_Sample_3_Data <- read_excel(file.path(path, "xrt_lcs/Goldstein_Sample_3_Data.xlsx"), col_types = c("skip", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric"))
